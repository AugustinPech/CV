...
let skills = [
  {
    ...
    longDesc: [
      "Ansible est un langage de script pour automatiser les exécutions de tâches sur des serveurs distants. Particulièrement efficace pour la mise en place de PaaS ou de SaaS.",
    ],
    imgPath:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhZqdh8uZdUtuh3Dpq5Fi7OPf3K0XCNUtxLw&s",
    tags: [
      "Infra",
      "FrontEnd",
      "BackEnd",
  ...
  },
  {
    ...
    longDesc: [
      ...
      "Configuration de Debian12 avec un preseed.cfg",
    ],
    imgPath:
      "https://www.sparks-formation.com/wp-content/uploads/2020/10/logo-kvm.png",
    ressources: [
      {
        description:
          "mes scripts pour l'installation d'un serveur avec Apache2, MariaDB et PHP8.2",
  ...
  },
  {
    ...
    ressources: [
      {
        description:
          "Différentes documentations autour du thème 'Système et réseau' ainsi que la réalisation des exercices lors de ma formation.",
  ...
  },
  {
    ...
    ressources: [
      ...
      {
        description:
          "Documentation de l'installation d'un logiciel pro de recherche en biologie.",
        link: [
          "https://github.com/AugustinPech/VirtualBox-Documentation/blob/main/notice_deepbgc_install.md",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    ressources: [
      {
        description:
          "Un script d'automatisation de déploiement de serveur avec Bottle & PythonAnywhere",
  ...
  },
  {
    ...
    longDesc: [],
    imgPath:
      "https://cdn.iconscout.com/icon/free/png-256/free-css3-9-1175237.png",
    tags: ["FrontEnd", "DevSkill"],
    ressources: [
      {
        description: "Mon CV interactif sur GitHub",
    ...
    ressources: [
      {
        ...
        link: [
          "https://www.figma.com/file/08MkHfT3OG7ySLs72u8GYM/SCHA-Doc.-(Copy)?type=design&mode=design&t=31orA3J1gR9usV2x-1",
        ],
      },
    ],
  },
  {
    ...
    longDesc: [],
    imgPath:
      "https://i.pinimg.com/originals/58/6b/be/586bbe06de2d9896b8ef4dda71caa13c.png",
...
exemple = {
  ...
  longDesc: [
    "Ullamco est culpa irure ea id aute aute proident eiusmod aliquip ea incididunt velit. Amet dolore qui non fugiat. Ipsum pariatur anim minim id ullamco ut. Aliquip velit enim do minim.",
  ],
  imgPath: "",
  tags: [
    "IDE",
